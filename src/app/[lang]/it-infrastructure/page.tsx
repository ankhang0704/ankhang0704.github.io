  ...
  return (
    <>
      ...
      <main className="pt-32 pb-20 relative overflow-x-hidden">
        {/* Case Study Header */}
        <section className="container mx-auto px-6 md:px-8 mb-20" data-aos="fade-up">
          ...
          <p className="text-xl font-light max-w-3xl opacity-80 leading-relaxed text-justify">
            {isVi
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            {["IT Operations", "Linux", "Cisco CCNA", "PostgreSQL", "PowerShell", "Server Backup"].map((tag) => (
              <span
                key={tag}
                className="text-[10px] font-bold uppercase tracking-widest border border-black/20 dark:border-white/20 px-4 py-1.5 opacity-60"
              >
                {tag}
              </span>
            ))}
        ...
        <section className="py-16 bg-cardLight dark:bg-cardDark border-y border-black/10 dark:border-white/10 mb-20">
          <div className="container mx-auto px-6 md:px-8">
            ...
            <div className="max-w-4xl mx-auto border border-black/10 dark:border-white/10 p-8 md:p-12 bg-bgLight dark:bg-bgDark">
              <div className="font-mono text-xs md:text-sm leading-relaxed overflow-x-auto opacity-90 space-y-6">
                <div className="text-center p-4 border border-black/20 dark:border-white/20">
                ...
                <div className="text-center font-bold">↓ Managed VLAN Switching</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                  ...
                  <div className="p-4 border border-black/20 dark:border-white/20 text-center">
                    ...
                    <div className="mt-3 pt-3 border-t border-black/10 dark:border-white/10 text-xs font-bold text-emerald-600 dark:text-emerald-400">
        ...
        <section className="container mx-auto px-6 md:px-8 max-w-5xl space-y-16 mb-20">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 border-t border-black/10 dark:border-white/10 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 border-t border-b border-black/10 dark:border-white/10 py-10">
