...
### 6.E DOM Cost
* Apply grain / noise filters EXCLUSIVELY to fixed pseudo-elements. NEVER on scrolling containers.

### 6.F Z-Index Restraint
NEVER spam arbitrary `z-50`. Use systemic layer contexts.
...
### 9.C Layout & Spacing
* **Mathematically perfect** padding and margins.
...
* **The em-dash (`—`) is COMPLETELY banned (See 9.G).**
...
[Refer to Section 14 in the source for the checklist]
